...
<div class="small-container">
  <h2 class="title">Bed Room Furniture</h2>
  <div class="row">
    <div class="col-4">
      <img src="images/drawer.jpg">
      <h4>Wooden Brown Drawer, 3 Draws</h4>
      <p>£40.00</p>
  </div>
  <div class="col-4">
    <img src="images/drawer2.jpg">
    <h4>Wooden Brown Drawer, 6 Draws</h4>
    <p>40.00</p>
</div>
</div>
</div>
...
<table>
  ...
  $sql = "SELECT product, name, price FROM items WHERE type ='BR'";
