...
<table class="tablestyle">
  ...
  <form action="signup.php" method="post">
    <label style="align: right;" for="firstname">First Name:
    </label>
    <input type="text" name="firstname" id="firstname" required placeholder="">
    <br>
    <label style="align: right;" for="surname">Surname:
    </label>
    ...
    <label style="align: right;" for="houseno">House number:
    </label>
    <input type="text"  id="houseno" required placeholder="">
    <br>
    <label style="align: right;" for="street">Street Name:
    </label>
    <input type="text"  id="street" required placeholder="">
    <br>
    ...
    <input type="text" id="postcode" required placeholder="">
    <br>
